...
testy_xi <- read_html("https://interpret.csis.org/translations/?_translation_author=xi-jinping&_paged=5")
...
extract_elements <- function(url, page_number) {
